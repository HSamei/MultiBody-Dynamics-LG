function Robot = def2Body(Theta,Theta_dot,Theta_ddot)
%#ok<*CCAT>
% RefModel = importrobot('iiwa14.urdf');    
    ...
    Body_2.f_prev    = F_0.*ones(1,Body_2.N);
    Body_2.f_pprev   = F_0.*ones(1,Body_2.N);
    ...
    Joint_2 = Joint('Joint_2','RIGID',[0;0;0;1;0;0],Theta(2),Theta_dot(2),Theta_ddot(2),[-pi,pi],0,Body_1,Body_2);

function [imind,cm,EE_POS] = Animate_MB_RE(Robot,Theta,NumStep,NumBod,PlotObj,Fig)
...
% Written by BD Bhai
    ...
    [POS,POS_R,POS_F] = Pos_SB_RE(Robot,Theta,NumStep);
...
%     end
    ...
    % Save EE_Pos to the function output
    EE_POS = POS(:,end);
